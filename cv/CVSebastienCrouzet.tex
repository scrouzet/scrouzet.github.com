...
%  Cauchoix* M, \textbf{Crouzet* SM}, Fize D, and Serre T (in revision). Fast ventral stream neural activity enables rapid visual categorization. \textit{PNAS}.
	
  \textbf{Crouzet SM}, Overgaard M \& Busch NA (in press). Visual masking leaves fastest saccadic responses intact. \textit{PLoS ONE}.
